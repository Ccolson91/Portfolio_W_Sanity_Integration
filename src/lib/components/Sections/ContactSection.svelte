<script lang="ts">
    ...
    function onSubmit(event: Event) {
        ...
        console.log(contactName, contactMail, infoAboutProject);
    }
    $effect(() => {
...
<section class="mt-l">
    ...
    <div class="form-container default-margin mt-m">
        <form>
            ...
            <textarea class:input-error={isFormInvalid && !Boolean(infoAboutProject.length)} placeholder="What's on your mind?" bind:value={infoAboutProject}></textarea>
            <Button onclick={onSubmit}>Submit</Button>
        </form>
        <div class="form-text">
            <h3 class="bold mb-s">Talk to me about your project</h3>
            <p>
                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Temporibus sunt atque dolores ea voluptates repellat quo doloribus, repudiandae non impedit eius inventore, pariatur magni suscipit magnam corporis maiores illo quasi?
            </p>
        </div>
    </div>
</section>
